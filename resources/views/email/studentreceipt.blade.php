...
<body>
    <span class="preheader">This is a receipt for your recent purchase on {purchase_date}. No payment is due with this
        receipt.</span>
                    ...
                    <tr>
                        <td class="email-masthead">
                            <a href="https://example.com" class="f-fallback email-masthead_name">
                                Online SES - Electron College of Technical Education
                            </a>
                        </td>
                    </tr>
                    <!-- Email Body -->
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>We are happy to let you know that you are now <strong>ENROLLED</strong>!
                                            </p>
                                  ...
                                  <td align="center">
                                    <a href="http://example.com" class="f-fallback button button--green" target="_blank">Use this discount now...</a>
                                            ...
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td>
                                                        <h3>{{ $mailData['transaction_number'] }}</h3>
                                                    </td>
                                                    <td>
                                                        <h3 class="align-right">{{ $mailData['transaction_date'] }}</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        <table class="purchase_content" width="100%" cellpadding="0"
                                                            ...
                                                            @foreach ($mailData['transaction_detail'] as $item)
                                                                <tr>
                                                                    <td width="80%" class="purchase_item"><span
                                                                            class="f-fallback">{{ $item['description'] }}</span>
                                                                    </td>
                                                                    <td class="align-right" width="20%"
                                                                        class="purchase_item"><span
                                                                            class="f-fallback">{{ $item['amount'] }}</span>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                            {{-- {/each} --}}
                                ...
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p class="f-fallback sub align-center">
                                            Online SES - Electron College of Technical
                                            Education
                                        </p>
                                    </td>
                                </tr>
